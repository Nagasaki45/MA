...
The last phase in the development of the system was to implement the BBRIP system into the open source Android application ``ScenePlayer'' (\cite{web:sceneplayer}), an Android port for the RjDj application mentioned in chapter \todo{add cross ref}, and release it again as ``ScenePlayer Plus'' (\cite{web:sceneplayerplus}).
...
The party consisted of four alternating interactive/control blocks of duration 5:40 minutes each (see figure \todo{TODO}).
...
Figure \todo{TODO} shows that there was a significant difference (unpaired t-test, t(33)=6.2, p<0.01) in the mean response to these questions (at a scale of 1-3).
...
Figure \todo{TODO} shows that there was also a significant difference in the mean response to these questions in the pre/post surveys.
