...
\todo[inline]{parts: Musical background (2 * IMS), Motivation (tech dependant social trends and AR), IPS, and starting point for the assessment. Reorder accordingly}
...
As pioneering technologies for digital sound synthesis, these programming languages gained wide acceptance in the music research community\todo{Not enough, elaborate more. Explain interactivity}.
...
Similar technological shifts also facilitated the usage of digital audio workstations (DAW)\todo{There is no reason to define DAW} as a common alternative to analog recording equipment in studios (\cite{leider:04}).
...
\todo[inline]{Explain a bit more about the ``makers''. Name some explicit influences on IMS. ``Today, the makers movement can be seen as...''}
...
\todo{A sentence that will lead the reader toward mobile apps is needed}For example, AutoRap turns speech into rap by slicing the syllables and mapping them according to different beat styles\footnote{Smule's AutoRap: \href{https://play.google.com/store/apps/details?id=com.smule.autorap}{https://play.google.com/store/apps/details?id=com.smule.autorap}.}.
...
A number of recent projects suggest the framework of distributing the role of a DJ between participants so that they can choose the music by themselves, thereby generating a playlist dynamically according to their musical tastes (\cite{web:shaw})\todo{Add reference to Dubnov project}.
...
\todo[inline]{Explain why the system in AR, by means of motivation}
