...
\begin{itemize}
    ...
    \item Does participating in a party using the system changes the ratio between in-group cohesion and ones openness to out-group social interactions? (assuming that the natural ratio is biased toward much more in-group cohesion as opposed to opennes to out-group interactions).
\end{itemize}

Exp1 results summary:

\begin{itemize}
    \item Higher levels of movements; n.s. evidance from BT measurements.
    \item Dance significantly less with people they knew in advance.
    \item Higher tendancy (n.s.) to participate in interactive party (compared to same question before experiment).
...
\begin{itemize}
    ...
    \item Interaction surveys: Negative results - tendancy for out-group interactions in the control group
    ...
    \item Interaction with the system (quality ovservation): Ad-hoc clustering and synchronized movement.
