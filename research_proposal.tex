...
Moreover, new music oriented programing languages continue to be developed, presenting features like ``on-the-fly'' programming (\citeauthor{web:chuck}), web capabilities (\ref{web audio api}) or modular, multi-touch environment for live performance (\citeauthor{web:usine}).
