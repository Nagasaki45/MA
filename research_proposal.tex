...
Supportive evidences to this argue could be found by the observation that human have neurological specialization for music processing; archaeological evidences indicate that music making in human settlements exist for more that 40,000 years; music evolved in any human culture independently and more (\cite{Huron2001}; \cite{mcdermott2005origins}).
...
\begin{tabularx}{\textwidth}{p{2in} | Y Y Y Y Y }
	...
	\hline
	In the last experiment block I've interacted with people I knew before the experiment & 1 & 2 & 3 & 4 & 5 \\
	\hline
	In the last experiment block I've interacted with people I didn't knew before the experiment & 1 & 2 & 3 & 4 & 5 \\
\end{tabularx}
