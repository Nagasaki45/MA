...
Traditionally, IMS merge development in several different threads such as music oriented softwares and programming languages (e.g.\ MUSIC-N and Max/MSP), standardization of technologies (e.g.\ MIDI and VST) and the recent emergence of ``makers culture'' (\cite{kuznetsov2010rise}), to facilitate new ways of music creation.
...
As opposed to early programming languages as GROOVE or the MUSIC-N series, most of those personal computer based languages still exist today and keep progressing\footnote{Max 6: \href{http://cycling74.com/products/max/}{cycling74.com/products/max/}.}.
...
With the arrival of the VST as the common standard for signal processing plug-ins for DAW\footnote{Steinberg technologies: \href{http://www.steinberg.net/en/company/technologies.html}{www.steinberg.net/en/company/technologies.html}.}, computers became even more essential tool for music production.
...
The system will be developed for the Android operation system\footnote{Android OS: \href{http://www.android.com/}{www.android.com/}.}.
