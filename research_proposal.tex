...
\todo[inline]{Decide if the section should discuss the results of the system development}

The experiments I have conducted was designed to answer the research question: \emph{does the system enhance social interaction between participants in an interactive silent disco party?}
...
Experiment I targets the main research question with positive results.
...
Overall, participants shows higher tendency to participate in interactive party, compared to the same question before the pre-experiment survey.
...
In contrast with Experiment I, the supportive value of experiment II results to the original hypotheses is much less determined.

Questions:

\begin{itemize}
    \item Does the system enhance social interaction between participants in an interactive silent disco party?
    \item Does participating in a party using the system strengthens the social relationships between participants even beyond the scope of the party?
    \item Does participating in a party using the system changes the ratio between in-group cohesion and ones openness to out-group social interactions? (assuming that the natural ratio is biased toward much more in-group cohesion as opposed to openness to out-group interactions).
\end{itemize}

Exp1 results summary:

\begin{itemize}
    \item Higher levels of movements; n.s. evidence from BT measurements.
    \item Dance significantly less with people they knew in advance.
    \item Higher tendency (n.s.) to participate in interactive party (compared to same question before experiment).
    \item Motivation to use video analysis based on social relationships clustering.
\end{itemize}

Exp2 results summary:

\begin{itemize}
    \item SUS: The interactive system rated significantly higher.
    \item Interaction surveys: Negative results - tendency for out-group interactions in the control group
    \item Social structure: Can't apply clustering on the data.
    \item Movement: Negative results - increasing levels in the control group.
    \item Interaction with the system (quality observation): Ad-hoc clustering and synchronized movement.
    \item Interaction with system: More participants around beacons. (More engaged?).
    \item Clustering algo: Participants are more dense.
    \item Clustering socio: Control group participants make out-group interactions where experiment group participants make in-group interactions.
\end{itemize}
...
On the other hand, in the control group, when the task became repetitive participants were more and more forced to create social interaction.
