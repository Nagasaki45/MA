...
\todo[inlien]{Rename ``blocks'' to ``sessions'' anywhere}
...
\todo[inline]{Explain how in-group and out-group analysis could use the video analysis results of experiment 1}
...
On the other hand, experiment II exposed lots of subtle nuances about the participants' social behavior as well as about the in-group and out-group interactions.

After the encouraging video analysis results of experiment I I have decided to cluster the participants into socially homogeneous groups and use those groups in my analysis of in-group cohesiveness and openness to out-group interactions.
As opposed to experiment I, in which participants were collected using advertisement on the internet, the participants of the second experiment were same class pupils, therefore homogeneous in advance.
...
Instead of enhancing the interactions between participants directly, as may arouse from the analysis of experiment I, using the system participants form dense clusters around the system's components.
...
Nevertheless, and similar to the results of experiment I, in experiment II participants were significantly more satisfied from the system as indicated explicitly by their self reported results in the system satisfaction survey.
