...
Another concept with high relevance to my work is Augmented Reality (AR).
...
In this research I will combine the concept of IMS with AR creating a system for real-time social interaction for the average user, using current mobile technology.
...
From the participants point of view the dance floor consists of few balloon bundles, each one marked up with a name of specific musical style (e.g.\ rock, jazz, Indian music as shown in figure \ref{fig:balloons}).
