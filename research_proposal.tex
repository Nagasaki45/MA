...
The system, which is mainly motivated by silent disco, flash mobs, and augmented reality, aims to create an interactive space, in which users can move, interact, and affect thereby the music they and their companions hear in their headphones.
...
Those results are integrated to describe a model for the enhanced social interaction, thereby displaying the potential of using audio-only augmented reality in future interactive experiences.
