...
\begin{figure}[!htb]
	...
	\caption{System architecture, Android application and Bluetooth beacons}\label{fig:sys:architecture}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{The system from the participant point of view}\label{fig:sys:participant_view}
\end{figure}
