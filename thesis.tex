...
\clearpage
\pagenumbering{Roman}  % roman numerals page numbering
\phantomsection
\addcontentsline{toc}{section}{Abstract}
\begin{abstract}
This thesis discusses the development and evaluation of an interactive music system.
The system provides a platform for the creation of spatial interactive music consumption experiences for non-professional musicians.
...
\pagenumbering{arabic}  % turn on numeric page numbering
...
\clearpage\section[System satisfaction survey]{System satisfaction survey\\
